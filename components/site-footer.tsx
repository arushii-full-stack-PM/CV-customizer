  ...
  return (
    <footer className="border-t border-border mt-0 pt-4 pb-6">
      <div className="mx-auto max-w-4xl px-6 flex flex-col gap-4">
        <div className="rounded-xl border border-primary/30 bg-primary/5 p-5 flex flex-col sm:flex-row items-center gap-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-primary text-sm font-bold text-white shadow-lg">
            AG
          </div>
          <div className="flex flex-col text-center sm:text-left flex-grow gap-1">
            <p className="text-[9px] font-bold uppercase tracking-widest text-primary">Created by</p>
            <p className="text-base font-bold text-white">Arushii Gupta</p>
